    ...
    return (
      ...
      <div class="flex justify-between">
        ...
        <div className="w-60 p-3 bg-white rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
            {/* <!-- Image --> */}
          <img  src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" alt="" className="h-40 object-cover rounded-xl" />
            <div className="p-2">
            {/* <!-- NAME --> */}
            ...
            <a role='button'>Contact No.- <br /> LinkedIn - </a>
            </div>
      </div>
      </div>
      ...
      <div className="bg-gray-1000 w-full min-h-screen gap-4 flex-wrap flex justify-center items-center">
        <div className="w-60 p-3 bg-white rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
            {/* <!-- Image --> */}
          <img  src="https://images.unsplash.com/photo-1506744038136-46273834b3fb?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=750&q=80" alt="" className="h-40 object-cover rounded-xl" />
            <div className="p-2">
