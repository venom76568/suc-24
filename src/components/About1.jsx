        ...
        <div className="content-column col-lg-6 col-md-12 col-sm-12">
          <div id="part1" className="flex items-center justify-evenly text-white ">
            ...
            >
              ...
              brighter future. Great ideas result in great undertakings that pave
          ...
          <div id="part2" className="flex items-center justify-evenly text-white">
            ...
            >
              ...
              of the Centre of Innovation, Nagpur, and Prime Minister Yuva Yojana, which
              aims to promote and develop the entrepreneurship culture amongst the
